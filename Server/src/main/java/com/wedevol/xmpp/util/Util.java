...
public class Util {
    ...
    public static final String BACKEND_ACTION_ADDGROUP = PACKAGE + ".ADDGROUP";
    public static final String BACKEND_ACTION_ADDUSER = PACKAGE + ".ADDUSER";
    public static final String BACKEND_ACTION_DELUSER = PACKAGE + ".DELUSER";
    public static final String BACKEND_ACTION_MIDPOINT = PACKAGE + ".MIDPOINT";
