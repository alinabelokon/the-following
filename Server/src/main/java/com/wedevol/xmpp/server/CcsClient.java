...
public class CcsClient implements PacketListener {
    ...
    private void handleNackReceipt(Map<String, Object> jsonMap) {
        ...
        } else if (errorCode.equals("BAD_REGISTRATION")) {
            handleUnrecoverableFailure(jsonMap);

        } else if (errorCode.equals("DEVICE_UNREGISTERED")) {
            handleUnrecoverableFailure(jsonMap);

        } else if (errorCode.equals("BAD_ACK")) {
            handleUnrecoverableFailure(jsonMap);

        } else if (errorCode.equals("SERVICE_UNAVAILABLE")) {
            handleServerFailure(jsonMap);

        } else if (errorCode.equals("INTERNAL_SERVER_ERROR")) {
            handleServerFailure(jsonMap);

        } else if (errorCode.equals("DEVICE_MESSAGE_RATE_EXCEEDED")) {
            handleUnrecoverableFailure(jsonMap);

        } else if (errorCode.equals("TOPICS_MESSAGE_RATE_EXCEEDED")) {
            handleUnrecoverableFailure(jsonMap);
